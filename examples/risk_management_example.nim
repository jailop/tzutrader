...
proc main() =
  ...
  # ===========================================================================
  # Example 1: No Risk Management (Baseline)
  # ===========================================================================
  ...
  let report1 = quickBacktest(symbol, strategy1, data, initialCash, verbose = false)
  ...
  # ===========================================================================
  # Example 2: Fixed Stop-Loss and Take-Profit
  # ===========================================================================
  ...
  let report2 = quickBacktest(symbol, strategy2, data, initialCash, verbose = false)
  ...
  let strategy3 = newRSIStrategy(period = 14, oversold = 30.0, overbought = 70.0)
    .withTrailingStop(trailPct = 3.0, activationPct = 5.0)
  strategy3.symbol = symbol
  
  let report3 = quickBacktest(symbol, strategy3, data, initialCash, verbose = false)
  ...
  let strategy4 = newStrategyBuilder(newRSIStrategy(period = 14, oversold = 30.0, overbought = 70.0))
    .withFixedStopLoss(5.0)       # 5% stop-loss
    .withRiskReward(2.0)          # 2:1 risk/reward = 10% take-profit
    .build()
  strategy4.symbol = symbol
  
  let report4 = quickBacktest(symbol, strategy4, data, initialCash, verbose = false)
  ...
  # ===========================================================================
  # Example 5: Multi-Level Take-Profit (Scaling Out)
  # ===========================================================================
  ...
  let strategy5 = newStrategyBuilder(newRSIStrategy(period = 14, oversold = 30.0, overbought = 70.0))
  ...
  let report5 = quickBacktest(symbol, strategy5, data, initialCash, verbose = false)
  ...
  # ===========================================================================
  # Example 6: Using withRiskManagement() Function
  # ===========================================================================
  
  echo "Example 6: Using withRiskManagement() Convenience Function"
  echo "-" .repeat(70)
  
  let strategy6 = newRSIStrategy(period = 14, oversold = 30.0, overbought = 70.0)
    .withRiskManagement(
  ...
  let report6 = quickBacktest(symbol, strategy6, data, initialCash, verbose = false)
