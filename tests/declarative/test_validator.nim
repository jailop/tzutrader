...
suite "Validator - Indicators":
  ...
  test "Valid indicators":
    var indicators = @[
      IndicatorYAML(id: "rsi_14", indicatorType: "rsi", params: initTable[
          string, ParamValue]()),
      IndicatorYAML(id: "sma_50", indicatorType: "sma", params: initTable[
          string, ParamValue]())
    ]
  ...
  test "Empty ID is invalid":
    var indicators = @[
      IndicatorYAML(id: "", indicatorType: "rsi", params: initTable[string,
          ParamValue]())
    ]
    let result = validateIndicators(indicators)
    check not result.valid
