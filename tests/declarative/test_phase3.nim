...
import ../../src/tzutrader/declarative/[expression, position_sizing, risk_management, condition_eval]
...
suite "Risk Management Tests":
  ...
  test "ATR-based stop loss":
    let stopLoss = newATRBasedStopLoss(atrMultiplier = 2.0, atrIndicatorId = "atr_14")
    let indicators = {"atr_14": 5.0}.toTable
