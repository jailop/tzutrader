...
suite "TripleMAStrategy Tests":
  test "Basic construction and parameters":
    let strat = newTripleMAStrategy(fastPeriod = 20, mediumPeriod = 50,
        slowPeriod = 200)
  ...
  test "Construction validates MA periods":
    expect ValueError:
      discard newTripleMAStrategy(fastPeriod = 50, mediumPeriod = 20,
          slowPeriod = 200)
    expect ValueError:
      discard newTripleMAStrategy(fastPeriod = 20, mediumPeriod = 200,
          slowPeriod = 50)
...
suite "FilteredMeanReversionStrategy Tests":
  test "Basic construction and parameters":
    let strat = newFilteredMeanReversionStrategy(rsiPeriod = 14,
        trendPeriod = 200)
  ...
  test "Construction with custom parameters":
    let strat = newFilteredMeanReversionStrategy(rsiPeriod = 10,
        trendPeriod = 100, oversold = 25.0, overbought = 75.0)
