...
proc newStrategyConfig*(name: string,
                       params: Table[string, float64] = initTable[string,
                           float64]()): StrategyConfig =
  ## Create a new strategy configuration
  result = StrategyConfig(name: name, params: params)

proc newTransaction*(symbol: string, action: Position, quantity, price,
    commission: float64): Transaction =
