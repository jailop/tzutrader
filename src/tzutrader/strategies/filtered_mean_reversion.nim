...
proc onData*(s: FilteredMeanReversionStrategy, bar: OHLCV): Signal =
...
proc reset*(s: FilteredMeanReversionStrategy) =
...
proc name*(s: FilteredMeanReversionStrategy): string =
