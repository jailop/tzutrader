## Parameter Sweep Runner for TzuTrader
##
## This module executes parameter sweeps - testing all combinations of
## parameter values to find optimal settings.
##
## Features:
## - Generate all parameter combinations
## - Run backtests for each combination
## - Collect and rank results
## - Export to CSV with parameter columns
##
## Phase 4 Feature
...
# ============================================================================
# Export Sweep Results with Parameters
# ============================================================================
...
proc runParameterSweepFromFile*(
  ...
  exportSweepResultsCSV(result, sweepConfig.output.fullResults, includeParams = true)
  ...
  exportSweepResultsCSV(bestResults, sweepConfig.output.bestResults, includeParams = true)
