## Condition Evaluation Engine for Declarative Strategies
##
## This module provides advanced condition evaluation capabilities including:
## - Indicator value caching and snapshots
## - Special "price" and "volume" pseudo-indicators
## - Historical value access (indicator[1], indicator[2])
...
proc createSnapshot*(bar: OHLCV, indicators: Table[string, float64]): IndicatorSnapshot =
...
proc parseHistoricalReference*(refStr: string): tuple[name: string, lookback: int] =
